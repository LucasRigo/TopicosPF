const UsuarioList = (props) => (
    <div>
        ...
        <button className="btn btn-primary btn-sm" onClick={props.onClickAtualizar} type="button">Atualizar Lista</button>
        <button className="btn btn-primary btn-sm" type="button">Inserir</button>
